package com.powerlift.appaid.id.io.morphia.config;
...
@Configuration
@PropertySource("classpath:mongodb-id-live.properties")
public class MorphiaConfig {
    ...
    private Morphia morphia(){
        ...
        morphia.mapPackage("com.powerliftsafesolution.appaid.id.io.morphia.entity");
